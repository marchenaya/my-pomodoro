...
// Vibrant Red/Orange theme for Pomodoro
val PrimaryLight = Color(0xFFBC161F)
...
val TertiaryLight = Color(0xFF715B29)
val OnTertiaryLight = Color(0xFFFFFFFF)
val TertiaryContainerLight = Color(0xFFFDE0A1)
...
val TertiaryDark = Color(0xFFDFC48C)
val OnTertiaryDark = Color(0xFF3F2E00)
val TertiaryContainerDark = Color(0xFF574414)
val OnTertiaryContainerDark = Color(0xFFFDE0A1)
